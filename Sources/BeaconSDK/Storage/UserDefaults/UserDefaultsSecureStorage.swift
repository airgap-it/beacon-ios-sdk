...
class UserDefaultsSecureStorage: SecureStorage {
    ...
    func getSDKSecretSeed(completion: @escaping (Result<String?, Swift.Error>) -> ()) {
    ...
    func setSDKSecretSeed(_ seed: String, completion: @escaping (Result<(), Swift.Error>) -> ()) {
        let keyAlias: String = {
