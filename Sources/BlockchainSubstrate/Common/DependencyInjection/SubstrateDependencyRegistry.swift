...
class SubstrateDependencyRegistry: ExtendedDependencyRegistry {
    ...
    var substrateDecoder: Substrate.Decoder { weakSubstrateDecoder.value }
    private lazy var weakSubstrateDecoder: LazyWeakReference<Substrate.Decoder> = LazyWeakReference {
        Substrate.Decoder()
    }
