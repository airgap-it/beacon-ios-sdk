...
class ConnectionControllerTests: XCTestCase {
    ...
    func testControllerSendsMessages() throws {
        ...
        let beaconConnectionMessage = BeaconIncomingConnectionMessage(origin: .p2p(id: "id"), content: versioned)
        let serializedConnectionMessage = SerializedIncomingConnectionMessage(
